...
if (!CIRCLE_API_KEY?.trim()) {
  console.warn("WARNING: CIRCLE_API_KEY environment variable is missing or empty");
}

if (!CIRCLE_ENTITY_SECRET?.trim()) {
  console.warn("WARNING: CIRCLE_ENTITY_SECRET environment variable is missing or empty");
}
